...
/**
 * \brief This will close and finalize an AHF_HALOS file.
 *
 * \param log  The logging object.
 * \param *f   Pointer to the variable holding the AHF_HALOS file object.
...
/**
 * \brief Initializes an opened for reading AHF_HALOS file.
 *
 * \param log  The logging object.
...
/**
 * \brief Reads from an opend AHF_HALOS file all particle information.
 *
 * This functions requires the file object to be opened by io_halos_open
 * and inititalized by io_halos_init. It also requires an abstract
...
/**
 * \brief Writes the particles to an AHF_HALOS binary file
 *
...
/**
 * \brief Writes the particles to an AHF_HALOS binary file in an ordered
 *        way.
 *
 * The file object given to the function needs to be opened for
 * writing.
